...
Unfinished work is tracked in `PLAN.md` — the unified model-catalog plan is complete (all `hfId`s verified against the HF Hub); next planned work per the growth spec (`docs/superpowers/specs/2026-08-25-public-tool-growth-design.md`) is Phase 2 (landing page + SEO).
